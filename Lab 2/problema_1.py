...
#Conjunto
demanda = {1:125,2:175,3:225, 4:250, 5:225, 6:200, 7:100}
oferta = {1:650, 2:700}
costos = {1:{1:999, 2:2.5}, 2:{1:2.5, 2:999}, 3: {1:1.6, 2:2.0}, 4:{1:1.4, 2:1.0}, 5:{1:0.8, 2:1.0}, 6:{1:1.4, 2:0.8}, 7:{1:0.5, 2:1.0}}
